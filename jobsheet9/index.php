...
$totalPelanggan = $stmtPelanggan->fetchColumn();

$stmtTransaksi = $koneksi->query("
    SELECT COUNT(*) FROM transaksi
");

$totalTransaksi = $stmtTransaksi->fetchColumn();

$stmtProses = $koneksi->query("
    SELECT COUNT(*)
    FROM transaksi
    WHERE status = 'Diproses'
");

$jumlahProses = $stmtProses->fetchColumn();

$stmtSelesai = $koneksi->query("
    SELECT COUNT(*)
    FROM transaksi
