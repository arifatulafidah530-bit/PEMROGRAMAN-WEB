...
$stmt = $koneksi->prepare('SELECT * FROM pelanggan WHERE id_pelanggan = :id');
$stmt->execute([':id' => $id]);
...
<main>
    <div class="page-header">
        ...
        <p>Ubah data pelanggan LaundryKu.</p>
    </div>
        ...
        <form action="proses_edit.php" method="POST">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" value="<?= htmlspecialchars($pelanggan['nama']) ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select id="jenis_layanan" name="jenis_layanan" required>
                        <?php foreach (['Cuci Kering', 'Cuci Setrika', 'Setrika'] as $layanan): ?>
                            <option value="<?= $layanan ?>" <?= $pelanggan['jenis_layanan'] === $layanan ? 'selected' : '' ?>><?= $layanan ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
